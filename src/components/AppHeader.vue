    ...
    <div>
        <div class="border-b border-sidebar-border/80">
            <div class="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                ...
                <button @click="navigateTo('/')" class="flex items-center gap-x-2 cursor-pointer">
                    <AppLogo />
                </button>
                            ...
                            <Tooltip>
                                <TooltipTrigger>
                                    ...
                                    >
                                        <Sun
                                            v-if="isDarkMode"
                                            class="size-5 opacity-80 group-hover:opacity-100 transition-all"
                                        />
                                        <Moon
                                            v-else
                                            class="size-5 opacity-80 group-hover:opacity-100 transition-all"
